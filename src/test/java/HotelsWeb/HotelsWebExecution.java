...
import Hotels_Web.Hotels_Web.HotelsWebElements;
import Hotels_Web.Hotels_Web.HotelsWebTest;
import junit.framework.Assert;


public class HotelsWebExecution {
	


		WebDriver driver;
		HotelsWebElements test=new HotelsWebElements();
	...
	HotelsWebTest hotelobj=new HotelsWebTest();
